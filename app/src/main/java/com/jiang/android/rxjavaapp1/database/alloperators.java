...
public class alloperators {
    ...
    private com.jiang.android.rxjavaapp.database.operators operators;
    ...
    public com.jiang.android.rxjavaapp.database.operators getOperators() {
        ...
        if (operators__resolvedKey == null || !operators__resolvedKey.equals(__key)) {
            ...
            com.jiang.android.rxjavaapp.database.operators operatorsNew = targetDao.load(__key);
            synchronized (this) {
    ...
    public void setOperators(com.jiang.android.rxjavaapp.database.operators operators) {
        synchronized (this) {
