...
public class DaoSession extends AbstractDaoSession {
    ...
    private final com.jiang.android.rxjavaapp.database.alloperatorsDao alloperatorsDao;
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        alloperatorsDaoConfig = daoConfigMap.get(com.jiang.android.rxjavaapp.database.alloperatorsDao.class).clone();
    ...
    public com.jiang.android.rxjavaapp.database.alloperatorsDao getAlloperatorsDao() {
